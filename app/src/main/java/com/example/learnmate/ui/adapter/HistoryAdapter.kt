...
//        private val tvUserAnswer: TextView = itemView.findViewById(R.id.tv_user_answer)
//        private val tvCorrectAnswer: TextView = itemView.findViewById(R.id.tv_correct_answer)
//
...
//
//            // Show user's answer
//            tvUserAnswer.text = "Your answer: ${question.options[question.selectedOption]}"
//
//            // Show correct answer
//            tvCorrectAnswer.text = "Correct answer: ${question.correctAnswer}"
//
//            // Change color based on correctness
//            val isCorrect = question.options[question.selectedOption] == question.correctAnswer
//            tvUserAnswer.setTextColor(
//                if (isCorrect) itemView.context.getColor(R.color.green)
...
//                    background = when {
//                        // If this is both the correct answer and user selected it
//                        isCorrectAnswer && isUserSelected ->
//                            resources.getDrawable(R.drawable.circle_green, null)
//                        // If this is the correct answer (regardless of selection)
//                        isCorrectAnswer ->
//                            resources.getDrawable(R.drawable.circle_green, null)
//                        // If this was incorrectly selected by user
//                        isUserSelected ->
//                            resources.getDrawable(R.drawable.circle_red, null)
//                        // Default case
//                        else ->
